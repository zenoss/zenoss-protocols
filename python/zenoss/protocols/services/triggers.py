...
from ..services import ProtobufRestServiceClient
from ..services.zep import ZepConnectionError
...
class TriggerServiceClient(object):
    ...
    def updateSubscriptions(self, uuid, subscriptionSet):
        ...
        @type subscriptionSet: zenoss.protocols.protobufs.zep_pb2.EventTriggerSubscriptionSet  # noqa E501
        """
